        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                Upload once. Track everything. Stay DOH compliant. LittleLedger streamlines document management for schools and families.
              </p>
            ...
            >
              <div className="relative">
                ...
                <div className="relative rounded-xl overflow-hidden border border-border/30 shadow-2xl bg-card">
                  <img 
                    src={parentDashboard} 
                    alt="LittleLedger dashboard showing student documents and compliance status" 
