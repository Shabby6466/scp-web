            ...
            <CardContent className="p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  LittleLedger ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our document management platform. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the application.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  LittleLedger is committed to maintaining HIPAA compliance for Protected Health Information (PHI). We implement appropriate administrative, physical, and technical safeguards to protect PHI, including:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Email:</strong> privacy@littleledger.com<br />
                    <strong className="text-foreground">Phone:</strong> (888) 555-1234<br />
                    <strong className="text-foreground">Mail:</strong> LittleLedger Privacy Team, 123 Document Lane, Suite 100, New York, NY 10001
                  </p>
                </div>
              </div>
