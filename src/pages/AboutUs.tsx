          ...
          <div className="container px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <p className="text-lg">
                  LittleLedger was born from firsthand experience with the administrative challenges faced by preschools and early childhood education centers. 
                ...
                <p className="text-lg">
                  We knew there had to be a better way. Drawing on our expertise in education technology and early childhood institutions we created LittleLedger, a platform designed specifically for the unique needs of early childhood education.
                </p>
                <p className="text-lg">
